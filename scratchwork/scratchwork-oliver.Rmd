...
We have a $p-$value of $0.1424 > 0.05$, so we fail to reject the null hypothesis at our significance level. 
...
m1 <- gam(log_deaths ~ bs(NDAM2014, df = 3), data = hurricane_logdeaths)
m2 <- gam(log_deaths ~ bs(NDAM2014, df = 4), data = hurricane_logdeaths)
m3 <- gam(log_deaths ~ bs(NDAM2014, df = 5), data = hurricane_logdeaths)
m4 <- gam(log_deaths ~ bs(NDAM2014, df = 6), data = hurricane_logdeaths)
m5 <- gam(log_deaths ~ bs(NDAM2014, df = 7), data = hurricane_logdeaths)
m6 <- gam(log_deaths ~ bs(NDAM2014, df = 8), data = hurricane_logdeaths)

# smoothing splines with varying df arguments (smoothing parameter)
m7 <- gam(log_deaths ~ s(NDAM2014, df = 3), data = hurricane_logdeaths)
...
m0 <- gam(log_deaths ~ s(NDAM2014, df = 7), data = hurricane_logdeaths)

m1 <- gam(log_deaths ~ s(NDAM2014, df = 7) + LF.PressureMB, 
          data = hurricane_logdeaths) # LF.PressureMB linearly included

# bsplines with varying df
m2 <- gam(log_deaths ~ s(NDAM2014, df = 7) + bs(LF.PressureMB, df = 3), 
          data = hurricane_logdeaths)
m3 <- gam(log_deaths ~ s(NDAM2014, df = 7) + bs(LF.PressureMB, df = 4), 
          data = hurricane_logdeaths)
m4 <- gam(log_deaths ~ s(NDAM2014, df = 7) + bs(LF.PressureMB, df = 5), 
          data = hurricane_logdeaths)
m5 <- gam(log_deaths ~ s(NDAM2014, df = 7) + bs(LF.PressureMB, df = 6), 
          data = hurricane_logdeaths)
m6 <- gam(log_deaths ~ s(NDAM2014, df = 7) + bs(LF.PressureMB, df = 7), 
          data = hurricane_logdeaths)
m7 <- gam(log_deaths ~ s(NDAM2014, df = 7) + bs(LF.PressureMB, df = 8), 
          data = hurricane_logdeaths)

# smoothing splines with varying df arguments (smoothing parameter)
m8 <- gam(log_deaths ~ s(NDAM2014, df = 7) + s(LF.PressureMB, df = 3), 
          data = hurricane_logdeaths)
m9 <- gam(log_deaths ~ s(NDAM2014, df = 7) + s(LF.PressureMB, df = 4), 
          data = hurricane_logdeaths)
m10 <- gam(log_deaths ~ s(NDAM2014, df = 7) + s(LF.PressureMB, df = 5), 
           data = hurricane_logdeaths)
m11 <- gam(log_deaths ~ s(NDAM2014, df = 7) + s(LF.PressureMB, df = 6), 
           data = hurricane_logdeaths)
m12 <- gam(log_deaths ~ s(NDAM2014, df = 7) + s(LF.PressureMB, df = 7), 
           data = hurricane_logdeaths)
m13 <- gam(log_deaths ~ s(NDAM2014, df = 7) + s(LF.PressureMB, df = 8), 
           data = hurricane_logdeaths)
...
final <- gam(log_deaths ~ s(NDAM2014, df = 7) + bs(LF.PressureMB, df = 6), 
          data = hurricane_logdeaths)
